...
var _todosData = __webpack_require__(17);
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            var todoItems = this.state.todos.map(function (item) {
                return _react2.default.createElement(_TodoItem2.default, { key: item.id, item: item, handleChange: _this2.handleChange });
            });
...
var NewTodo = function (_Component) {
    ...
    function NewTodo() {
        ...
        var _this = _possibleConstructorReturn(this, (NewTodo.__proto__ || Object.getPrototypeOf(NewTodo)).call(this));
    ...
    _createClass(NewTodo, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'text', placeholder: 'New Todo', value: this.state.NewTodo.text, onChange: function onChange(event) {
                        _this2.setState({
                            NewTodo: {
